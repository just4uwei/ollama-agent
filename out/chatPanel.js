...
exports.ChatPanelHtml = exports.ChatPanel = void 0;
 ...
 */
class ChatPanel {
    constructor(extensionUri, viewColumn = vscode.ViewColumn.Beside // Open beside the active editor (right side)
    ) {
        this._disposables = [];
        this._extensionUri = extensionUri;
        this._panel = vscode.window.createWebviewPanel('ollamaAgent.chatPanel', '🤖 Ollama Agent', { viewColumn, preserveFocus: false }, {
            enableScripts: true,
    ...
    _buildHtml() {
        ...
        return exports.ChatPanelHtml;
    }
    /** Open or reveal the right-side panel */
    static openOrReveal(extensionUri) {
...
exports.ChatPanelHtml = `<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
